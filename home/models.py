...
class ayushVaccineSlot(models.Model):
    ...
    vaccine_type = CharField(
        max_length=200, default="null", null=True, blank=True)
    min_age_limit = IntegerField(default="null", null=True, blank=True)
    available_capacity = IntegerField(default="null", null=True, blank=True)
...
class Member_info_Class(models.Model):
    ...
    second_booking = models.DateField(null=True, blank=True)
